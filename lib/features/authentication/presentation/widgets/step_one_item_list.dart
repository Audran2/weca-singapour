...
import '../../utils/step_one_data.dart';
...
class _StepOneItemListState extends State<StepOneItemList> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> items = StepOneData.getItemsForStep(widget.currentSubStep);
      ...
      child: SingleChildScrollView(
        child: Wrap(
          ...
          children: items.map((item) {
            ...
            final bool isSelected = onboardingViewModel.isItemSelected(widget.currentSubStep, item["title"]!);

            return GestureDetector(
              onTap: () => onboardingViewModel.toggleSelection(widget.currentSubStep, item["title"]!),
  ...
  Widget _buildCard(Map<String, String> item, int index, bool isExpanded, bool isSelected) {
    return Column(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSelected ? ChartColors.primary200 : ChartColors.secondary50,
